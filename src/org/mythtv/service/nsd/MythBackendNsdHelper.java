...
public class MythBackendNsdHelper extends MythNsdHelper {

	private static final String TAG = MythBackendNsdHelper.class.getSimpleName();

	private static final String SERVICE_NAME_PREFIX = "Mythbackend on ";

	public static final String SERVICE_TYPE = "_mythbackend._tcp.";

	private String mServiceName = "";
	
	public MythBackendNsdHelper( Context context, MythServiceDiscoveryListener listener ) {
